...
def GetQuestions(request):
    ...
    courseName = request.data['courseName']
    moduleNumber = request.data['moduleNumber']
    # print(username,gradeNumber,classNumber,courseName,moduleNumber)
    data=fetchQuestionsByStudents(gradeNumber, classNumber, courseName, moduleNumber)
    query= data['questions']
    return Response({"message":"success", "data": query})
